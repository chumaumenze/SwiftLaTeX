(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SwiftLatex = {}));
})(this, (function (exports) { 'use strict';

  var _documentCurrentScript = typeof document !== 'undefined' ? document.currentScript : null;
  var Xetex = (() => {
    var _scriptDir = (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('swiftlatex.js', document.baseURI).href));
    return async function(moduleArg = {}) {
      ...
      if (ENVIRONMENT_IS_NODE) {
        ...
        var require$1 = createRequire((typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('swiftlatex.js', document.baseURI).href)));
        var fs = require$1("fs");
        var nodePath = require$1("path");
        if (ENVIRONMENT_IS_WORKER) {
          scriptDirectory = nodePath.dirname(scriptDirectory) + "/";
        } else {
          scriptDirectory = require$1("url").fileURLToPath(new URL("./", (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('swiftlatex.js', document.baseURI).href))));
        }
      ...
      if (Module["locateFile"]) {
        ...
        wasmBinaryFile = new URL("swiftlatexxetex.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('swiftlatex.js', document.baseURI).href))).href;
      }
      ...
      FS.staticInit();
      var wasmImports = { j: ___assert_fail, F: ___syscall_faccessat, q: ___syscall_fcntl64, C: ___syscall_getcwd, H: ___syscall_ioctl, n: ___syscall_openat, D: ___syscall_stat64, w: __emscripten_throw_longjmp, t: __localtime_js, r: __mmap_js, s: __munmap_js, y: __tzset_js, d: _abort, o: _emscripten_date_now, z: _emscripten_get_heap_max, E: _emscripten_memcpy_js, x: _emscripten_resize_heap, A: _environ_get, B: _environ_sizes_get, g: _exit, m: _fd_close, G: _fd_read, u: _fd_seek, p: _fd_write, i: invoke_ii, c: invoke_iii, k: invoke_iiii, a: invoke_iiiii, b: invoke_iiiiii, e: invoke_v, f: invoke_vi, h: invoke_vii, I: _kpse_find_file_js, l: _strftime, v: _strftime_l };
      ...
      Module["_setMainEntry"] = (a0) => (Module["_setMainEntry"] = wasmExports["P"])(a0);
      var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["Q"])(a0, a1);
      var ___errno_location = () => (___errno_location = wasmExports["S"])();
      var _emscripten_builtin_memalign = (a0, a1) => (_emscripten_builtin_memalign = wasmExports["T"])(a0, a1);
      ...
      if (Module["noInitialRun"])
        shouldRunNow = false;
      run();
      const engine = { PDFTEX: 0, XETEX: 1, DVIPDF: 2 };
      ...
      function makeLatex(engineType, target) {
        ...
        let status = compile();
        if (status !== 0) {
          const err2 = Error("Compilation failed, with status code " + status);
          return { err: err2, log: Module.memLog, errLog: Module.memErrLog };
        }
        try {
          _compileBibtex();
        } catch (err2) {
          console.error("Ignoring bibtex exceptions", err2);
        }
        let data;
      ...
      Module.onRuntimeInitialized = function() {
        ...
        Module.setMainFile = function(filePath) {
          if (!filePath.startsWith("/"))
            filePath = "/" + filePath;
        ...
        Module.setTexliveURL = function(url) {
          if (typeof url !== "string") {
        ...
        self.onmessage = function(ev) {
          ...
          switch (cmd) {
            ...
            case "flushCache":
              ...
              break;
            default:
              self.postMessage({ err: Error("Unknown command: " + cmd), cmd });
          }
        };
      }
      let texlive404Cache = {};
  ...
  var PDFTex = (() => {
    ...
    return async function(moduleArg = {}) {
      ...
      if (Module["locateFile"]) {
        ...
        wasmBinaryFile = new URL("swiftlatexpdftex.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('swiftlatex.js', document.baseURI).href))).href;
      }
      function getBinarySync(file) {
        if (file == wasmBinaryFile && wasmBinary) {
          return new Uint8Array(wasmBinary);
      ...
      FS.createPreloadedFile = FS_createPreloadedFile;
      FS.staticInit();
      var wasmImports = { a: ___assert_fail, F: ___syscall_faccessat, p: ___syscall_fcntl64, C: ___syscall_getcwd, H: ___syscall_ioctl, D: ___syscall_openat, y: ___syscall_rmdir, x: ___syscall_stat64, z: ___syscall_unlinkat, u: __emscripten_throw_longjmp, s: __localtime_js, w: __tzset_js, f: _abort, m: _emscripten_date_now, E: _emscripten_memcpy_js, v: _emscripten_resize_heap, A: _environ_get, B: _environ_sizes_get, l: _exit, o: _fd_close, G: _fd_read, t: _fd_seek, n: _fd_write, I: invoke_i, i: invoke_ii, d: invoke_iii, j: invoke_iiii, b: invoke_iiiii, c: invoke_iiiiii, e: invoke_v, h: invoke_vi, g: invoke_vii, r: _kpse_find_file_js, q: _kpse_find_pk_js, k: _strftime };
      var wasmExports = createWasm();
      var _malloc = (a0) => (_malloc = wasmExports["L"])(a0);
      var _compileLaTeX = Module["_compileLaTeX"] = () => (_compileLaTeX = Module["_compileLaTeX"] = wasmExports["M"])();
      var _compileFormat = Module["_compileFormat"] = () => (_compileFormat = Module["_compileFormat"] = wasmExports["N"])();
  ...
  var DviPDF = (() => {
    ...
    return async function(moduleArg = {}) {
      ...
      if (Module["locateFile"]) {
        ...
        wasmBinaryFile = new URL("swiftlatexdvipdfm.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('swiftlatex.js', document.baseURI).href))).href;
      }
      function getBinarySync(file) {
        if (file == wasmBinaryFile && wasmBinary) {
          return new Uint8Array(wasmBinary);
      ...
      FS.createPreloadedFile = FS_createPreloadedFile;
      FS.staticInit();
      var wasmImports = { a: ___assert_fail, i: ___syscall_faccessat, d: ___syscall_fcntl64, v: ___syscall_fstat64, x: ___syscall_ioctl, t: ___syscall_newfstatat, f: ___syscall_openat, r: ___syscall_rmdir, u: ___syscall_stat64, s: ___syscall_unlinkat, o: __emscripten_throw_longjmp, l: __gmtime_js, q: __tzset_js, j: _abort, g: _emscripten_date_now, h: _emscripten_memcpy_js, p: _emscripten_resize_heap, b: _fd_close, w: _fd_read, m: _fd_seek, c: _fd_write, e: invoke_iii, n: invoke_iiiiiiiiiij, k: invoke_vii, y: _kpse_find_file_js };
      var wasmExports = createWasm();
      var _malloc = (a0) => (_malloc = wasmExports["B"])(a0);
      var _compilePDF = Module["_compilePDF"] = () => (_compilePDF = Module["_compilePDF"] = wasmExports["D"])();
      Module["_setMainEntry"] = (a0) => (Module["_setMainEntry"] = wasmExports["E"])(a0);
      var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["F"])(a0, a1);
      var ___errno_location = () => (___errno_location = wasmExports["G"])();
      ...
      var dynCall_iiiiiiiiiij = Module["dynCall_iiiiiiiiiij"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) => (dynCall_iiiiiiiiiij = Module["dynCall_iiiiiiiiiij"] = wasmExports["L"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
      function invoke_iii(index, a1, a2) {
        var sp = stackSave();
        try {
          return getWasmTableEntry(index)(a1, a2);
  ...
  exports.DviPDF = DviPDF;
  exports.PDFTex = PDFTex;
  exports.Xetex = Xetex;
